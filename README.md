...
> **"Designed for Users, Structured for Developers."** 사용자의 경험을 설계하고, 개발자가 읽기 좋은 구조로 구현하는 김다빈의 포트폴리오입니다.
...
저는 화면의 한 줄 여백, 한 번의 스크롤에도 이유가 있어야 한다고 믿습니다. 이 포트폴리오는 그 고민의 흔적들을 녹인 프로젝트입니다.
